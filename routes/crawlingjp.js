...
lastpage = async(page) => {
    await page.goto("https://lampcook.com/food/food_dic_menu3.php");
...
getdata = async() => {
    ...
    var URL = "https://lampcook.com/food/food_dic_menu3.php?pagenum=";
    ...
    //fs.writeFileSync('jafood.json', JSON.stringify(dataset));
    await browser.close();
}
